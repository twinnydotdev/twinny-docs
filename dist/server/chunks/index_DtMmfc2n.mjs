const id = "zh-cn/index.mdx";
					...
					},actions:[{text:"开始使用",link:"/twinny-docs/zh-cn/general/quick-start",variant:"secondary",icon:{type:"icon",name:"right-arrow"}}]},sidebar:{hidden:false,attrs:{}},pagefind:true};
						const _internal = {
							type: 'content',
