const id = "index.mdx";
					...
					},actions:[{text:"Getting Started",link:"/twinny-docs/general/quick-start",variant:"secondary",icon:{type:"icon",name:"right-arrow"}}]},sidebar:{hidden:false,attrs:{}},pagefind:true};
						const _internal = {
							type: 'content',
