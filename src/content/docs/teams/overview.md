...
| --- | --- | --- | --- |
| Developers (active keys) | up to 5 | as many seats as you buy | from 50 |
...
| Cost | nothing, forever | $6 per seat per month, billed yearly | $10 per seat per month, billed yearly |
